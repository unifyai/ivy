...
def ravel_multi_index(
    ...
    *,
    ...
    """
    Convert a tuple of index arrays into an array of flat indices, applying boundary
    ...
    array([12, 13, 13])
    """
    return ivy.current_backend(arr).ravel_multi_index(arr, dims, mode=mode, order=order)
